resource "azurerm_resource_group_template_deployment" "pipeline_Ingest_QA_DLP_Dataset" {
  name                = "pipeline_Ingest_QA_DLP_Dataset"
  ...
  depends_on = [
    azurerm_data_factory_custom_dataset.ds_QA_DLP_Dataset
  ]
}
