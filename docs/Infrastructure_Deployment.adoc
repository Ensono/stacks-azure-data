...
Log in to the bastion and set up taskctl and clone the repo from GitHub as done earlier in this guide. Follow the same steps until you have taskctl installed on the bastion server and ensure you have the shell script that has all the necessary environment variables. 
